...
var remoteDataUrl = "https://raw.githubusercontent.com/neelsmith/wamcoins/master/tabs-ocre/ocre-full.tsv"
var idParam = "OCRE"
...
function doTabulator(results){
	...
	$("#bcdata-table").tabulator({
	    ...
	    fitColumns:false, //fit columns to width of table (optional)
			columns:[
				{title:"OCRE", field:"OCRE", variableHeight:true, sorter:"string", align:"left", sortable:true, formatter:function(cell, formatterParams){
