...
function doTabulator(results){
	...
	$("#bcdata-table").tabulator({
	    ...
	    fitColumns:false, //fit columns to width of table (optional)
      	...
      	{title:"Label", field:"Label", headerFilter:true, variableHeight:true, sorter:"string", align:"left", sortable:true},
        {title:"Issue", field:"Issue", headerFilter:true, variableHeight:true, sorter:"string", align:"left", sortable:true},
        {title:"Material", field:"Material", headerFilter:true, variableHeight:true, sorter:"string", align:"left", sortable:true},
        {title:"Denomination", field:"Denomination", headerFilter:true, variableHeight:true, sorter:"string", align:"left", sortable:true},
        {title:"Weight (g)", field:"Weight", headerFilter:true, variableHeight:true, sorter:"string", align:"left", sortable:true},
        {title:"Die Axis", field:"Die-Axis", headerFilter:true, variableHeight:true, sorter:"string", align:"left", sortable:true}
